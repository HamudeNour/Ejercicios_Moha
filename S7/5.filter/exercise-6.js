...
// para generar un nuevo array con los streamers que incluyan el caracter 'Legends' 
...
function mayorQue35(streamer){

     streamer.age > 35 ? streamer.gameMorePlayed = streamer.gameMorePlayed.toUpperCase() : "";

     return streamer;
}
let newStreamers = streamers.filter(filtrarStreamers).filter(mayorQue35);
